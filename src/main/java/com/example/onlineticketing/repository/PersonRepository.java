...
public interface PersonRepository extends JpaRepository<Person, Long> {
    ...
    @Query(value = "select new com.example.onlineticketing.dto.util.ValueLabelDropdown( " +
            "   p.id, p.firstName, p.lastName ) " +
            "   from Person p where isDoctor = true")
    List<ValueLabelDropdown> findAllDoctorDropdown();
